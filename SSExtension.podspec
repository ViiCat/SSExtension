...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/liujie/SSExtension'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'liujie' => 'liujie@duckdake.com' }
  s.source           = { :git => 'https://github.com/liujie/SSExtension.git', :tag => s.version.to_s }
